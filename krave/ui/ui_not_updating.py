...
class UI():
    ...
    def plot_data(self, end = False):
        print("plot_data called, updating plot image.")
        ...
        try:
            ...
            print(f"Data being plotted (first 5 rows):\n{data.head()}")
        except Exception as e:
    ...
    def check_for_data_update(self):
        print("Checking for data update...")
        ...
        if detect_change(self._source_data_path, self._last_mod_time):
            print("Data file change detected!")
            ...
            if self._first_change:
                ...
                print(f"Read data file, num rows: {self._num_rows}")

                diff = (self._num_rows - 2) - self._index #New rows added since last check
                print(f"New rows to process: {diff}")
                ...
                for i in range(diff):
                    ...
                    print(f"Analyzed data for new row {new_index}: {output_analyzed_data}")
                    ...
                    if output_analyzed_data:
                        ...
                        if self._last_trial != -1:
                            ...
                            print("Wrote new analyzed data, calling plot_data...")
